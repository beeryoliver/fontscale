\ProvidesFile{fontscale-input-musical.tex}[2026-09-02]

\begin{table}
  \centering
  \caption
    {%
      The font size of each font size command from \cs{tiny} to \cs{Huge} set
      by the keys \key{typographic-scale=musical}, \key{musical/ratio=\num{2}},
      and \key{musical/notes=\num{5}} with different values for the key
      \key{musical/base}.
