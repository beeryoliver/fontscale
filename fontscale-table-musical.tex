\ProvidesFile{fontscale-table-musical.tex}[2025-11-07]

\begin{table}
  \centering
  \caption
    {%
      The font size of each font size command from \cs{tiny} to \cs{Huge} when setting the keys \key{typographic-scale=musical}, \key{musical/ratio=\num{2}}, and \key{musical/notes=\num{5}} with different values for the key \key{musical/base}.
